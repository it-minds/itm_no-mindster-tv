...
import IsabelInAustralia from "@/commons/assets/images/australia.jpg";
...
export default function Home() {
    return (
        <Frame>
            ...
            <Framed width={5} height={5} col={1} row={1}>
                <LunchModule />
            </Framed>
            <Framed row={1} col={6} height={5} width={4}>
                <Image
                    className="h-full w-full object-cover"
                    src={IsabelInAustralia}
                    alt="Australia"
                />
            </Framed>
            <Framed row={1} col={10} height={5} width={4}>
